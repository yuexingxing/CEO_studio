...
import com.tajiang.ceo.model.FlowLayoutLine;

import java.util.ArrayList;
import java.util.List;

/**
 * Created by Admins on 2017/2/15.
 */

public class TJFlowLayout extends ViewGroup {
    //靠左放置标签
    ...
    // 行集合
    private List<FlowLayoutLine> lines = new ArrayList<FlowLayoutLine>();
    // 当前的行
    private FlowLayoutLine line;
    // 当前行使用的空间
    ...
    public TJFlowLayout(Context context) {
        super(context);
    }

    public TJFlowLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public TJFlowLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        // 把所有行的高度加上
        int totalHeight = 0;
        for (FlowLayoutLine curLine: lines) {
