...
//                    Log.d(TAG, "remainder: " + remainder + ", divided: " + divided);
    ...
    private TextView createView(String item) {
        ...
        int paddingLeftAndRight = dip2px(15);
        int paddingTopAndBottom = dip2px(5);
...
//            position = divided + offset + 1;
        ...
        for (int i = 0; i < childSize; i++) {
            ...
            if (position == i) {
                itemView.setTextColor(Color.parseColor("#030303"));
            } else {
    ...
    public void setBackgroundDrawable(Drawable background) {
        ...
        background = new Drawable() {
            ...
            public void draw(Canvas canvas) {
                paint.setColor(Color.parseColor("#d8d8d8"));  //上边框线颜色
                canvas.drawLine(0, obtainSelectedAreaBorder()[0], viewWidth, obtainSelectedAreaBorder()[0], paint);
                paint.setColor(Color.parseColor("#cccccc"));  //下边框线颜色
